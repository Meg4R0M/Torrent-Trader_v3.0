...
// print the faq table
 ...
 foreach ($faq_categ as $id => $temp) {
  print("<br />\n<table border=\"0\" class=\"table_table\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n");
  ...
  print("</select></td><td class=\"table_col2\" align=\"center\" width=\"40px\">&nbsp;</td><td class=\"table_col1\"><b>". stripslashes($faq_categ[$id][title]) ."</b></td><td class=\"table_col2\" align=\"center\" width=\"60px\">". $status ."</td><td class=\"table_col1\" align=\"center\" width=\"60px\"><a href=\"faq-actions.php?action=edit&amp;id=". $id ."\">edit</a> <a href=\"faq-actions.php?action=delete&amp;id=". $id ."\">delete</a></td></tr>\n");

  if (array_key_exists("items", $faq_categ[$id])) {
   foreach ($faq_categ[$id][items] as $id2 => $temp) {
    print("<tr><td class=\"table_col1\" align=\"center\" width=\"40px\">&nbsp;</td><td class=\"table_col2\" align=\"center\" width=\"40px\"><select name=\"order[". $id2 ."]\">");
    ...
    print("</select></td><td class=\"table_col1\">". stripslashes($faq_categ[$id][items][$id2][question]) ."</td><td class=\"table_col2\" align=\"center\" width=\"60px\">". $status ."</td><td class=\"table_col1\" align=\"center\" width=\"60px\"><a href=\"faq-actions.php?action=edit&amp;id=". $id2 ."\">edit</a> <a href=\"faq-actions.php?action=delete&amp;id=". $id2 ."\">delete</a></td></tr>\n");
   }
  }

  print("<tr><td colspan=\"5\" align=\"center\" class='table_head'><a class='inpt' href=\"faq-actions.php?action=additem&amp;inid=". $id ."\">Add new item</a></td></tr>\n");
  print("</table>\n");
 }
}
