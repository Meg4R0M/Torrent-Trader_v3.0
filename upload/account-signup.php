...
if ($_GET["takesignup"] == "2") {
  ...
  if ($message == "") { 
    ...
    SQL_Query_exec("INSERT INTO users (username, password, secret, email, status, added, last_access, age, country, gender, client, stylesheet, language, class, ip) VALUES (" . 
      ...
      // Add new member to shoutbox
      $query = "INSERT INTO shoutbox (uid, date, name, text) VALUES (0, '".get_date_time()."', 'System', 'Bienvenue à notre nouveau membre: :[url=".$site_config['SITEURL']."/account-details.php?id=".$id."]".$wantusername."[/url]')";
