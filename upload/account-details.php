...
//
//  TorrentTrader v2.x
//      $LastChangedDate: 2012-07-16 17:12:24 +0100 (Mon, 16 Jul 2012) $
...
//$moods
$res = SQL_Query_exec("SELECT name, moodspic FROM moods WHERE id=$user[moods] LIMIT 1") or die(mysql_error());
if (mysql_num_rows($res) == 1){
$arr = mysql_fetch_assoc($res);
$moods = "";
}
