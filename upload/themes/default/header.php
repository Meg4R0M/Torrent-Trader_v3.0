...
$slots = number_format($maxslot) . "/" . number_format($query_slots[0]);
    ...
    echo " <a class='profile' href='/account/'><img src='/images/setting.png' border='none' height='20' width='20' alt='Account Setting' title='Account Setting'></a> <a class='account' href='../user/?id=$CURUSER[id]'><img src='../images/profile.png' border='none' height='20' width='20' alt='Profile' title='Profile'></a> <a class='logout' href=\"".$site_config["SITEURL"]."/account-logout.php\"><img src='../images/logout.png' border='none' height='20' width='20' alt='Logout' title='Logout'></a>";
    ...
    if ($unreadmail){
        ...
        print("<embed src='../mail.mp3' autostart='true' width='0' height='0' hidden='true'><a class='mail_n' href='/message/?inbox'><img src='/images/mails.png' border='none' height='20' width='20' alt='New PM' title='($unreadmail) New PM'S'><font color='red'>($unreadmail)</font><p></a>&nbsp;&nbsp;");
    
    }else{
    
        print("<a class='mail' href='/message/'><img src='/images/mail.png' border='none' height='20' width='20' alt='My Messages' title='My Messages'></a>&nbsp;");
...
<!-- END INFOBAR -->
    ...
    <div class='header'>
      <div id='logo'><a href='/'><img src='/images/blank.gif' width='360' height='64' /></a></div>
    </div>
    <div id='menu'>
      <!-- START NAVIGATION -->
      <ul class='menu'>
        <li><a href='/'><span>Home</span></a></li>
        <li><a href='/lounge.php'><span>Lounge</span></a></li>
        <li><a href='/torrents-upload.php'><span>Upload</span></a></li>
        <li><a href='/torrents.php'><span>Browse</span></a></li>
        <li><a href='/torrents-search.php'><span>Search</span></a></li>
        <li><a href='/forums.php'><span>Community</span></a></li>
   <li><a href='/memberlist.php'><span>Members</span></a></li>
   <li><a href='/torrents-today.php'><span>Latest</span></a></li>
  ...
  <div class='myTable'>
    <div class='myTrow'>
      <div class='shad-l'><img src='/images/blank.gif' width='9px' height='9px' /></div>
      <div class='main'>
