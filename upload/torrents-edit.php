...
echo "<tr><td class='table_col1' align='right'><b>" . T_("POSTER") . ": </b></td><td class='table_col2'><input type='text' name='poster' size='50' /><br>(Direct link for a poster image to be shown on the details page)\n</td></tr>";
