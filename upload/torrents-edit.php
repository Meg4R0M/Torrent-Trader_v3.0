...
//
//  TorrentTrader v2.x
//      $LastChangedDate: 2012-04-23 21:48:33 +0100 (Mon, 23 Apr 2012) $
...
echo "<tr><td class='table_col1' align='right'><b>" . T_("POSTER") . ": </b></td><td class='table_col2'><input type='text' name='poster' size='50' value='".htmlspecialchars($row['poster'])."'/><br>(Direct link for a poster image to be shown on the details page)\n</td></tr>";
...
echo("<tr><td align='right' class='table_col1'><b>".T_("IMDB")."</b></td><td class='table_col2'><input type='text' name='imdb' size='60' value='" . htmlspecialchars($row['imdb']) . "' /></td></tr>");
