...
$UClass=@mysql_fetch_array(@SQL_Query_exec("SELECT Color, level,  username, gender, avatar, added, age, class, donated, warned FROM users JOIN groups ON users.class=groups.group_id WHERE users.id=".$row[uid].""));
