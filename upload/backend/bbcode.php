...
<table align='center' border='0' cellpadding='6' cellspacing='0'>
  <tr class='b-title'>
    <th colspan="2" align='center' valign="middle"><table border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td align="center"><input style="font-weight: bold;" type="button" name="bold" value="B " class="btn-danger"  onclick="javascript: BBTag('[b]','bold','<?php echo $name; ?>','<?php echo $form; ?>')" /></td>
          <td align="center"><input style="font-style: italic;" type="button" name="italic" value="I " class="btn-danger"  onclick="javascript: BBTag('[i]','italic','<?php echo $name; ?>','<?php echo $form; ?>')" /></td>
          <td align="center"><input style="text-decoration: underline;" type="button" name="underline" value="U " class="btn-danger"  onclick="javascript: BBTag('[u]','underline','<?php echo $name; ?>','<?php echo $form; ?>')" /></td>
          <td align="center"><input type="button" name="li" value="List " class="btn-danger"  onclick="javascript: BBTag('[*]','li','<?php echo $name; ?>','<?php echo $form; ?>')" /></td>
          <td align="center"><input type="button" name="quote" value="QUOTE " class="btn-danger"  onclick="javascript: BBTag('[quote]','quote','<?php echo $name; ?>','<?php echo $form; ?>')" /></td>
          <td align="center"><input type="button" name="url" value="URL " class="btn-danger"  onclick="javascript: BBTag('[url]','url','<?php echo $name; ?>','<?php echo $form; ?>')" /></td>
          <td align="center"><input type="button" name="img" value="IMG " class="btn-danger" onclick="javascript: BBTag('[img]','img','<?php echo $name; ?>','<?php echo $form; ?>')" /></td>
        </tr>
    </table>
    </th>  </tr>
  <tr class='b-row'>
