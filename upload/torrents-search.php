...
//
//  TorrentTrader v3.x
//      $LastChangedDate: 2016-10-05 16:36:21 +0000 (Wed, 05 Oct 2016) $
...
function sqlwildcardesc($x){
    return str_replace(array("%","_"), array("\\%","\\_"), ((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $x) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : "")));
}
...
if (isset($cleansearchstr)) {
    $wherea[] = "MATCH (torrents.name) AGAINST ('".((isset($GLOBALS["___mysqli_ston"]) && is_object($GLOBALS["___mysqli_ston"])) ? mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $searchstr) : ((trigger_error("[MySQLConverterToo] Fix the mysql_escape_string() call! This code does not work.", E_USER_ERROR)) ? "" : ""))."' IN BOOLEAN MODE)";
...
if ($parent_cat){
    echo "<br /><br /><b>".T_("YOU_ARE_IN").":</b> <a href='../browse/?parent_cat=$parent_cat'>$parent_cat</a><br /><b>".T_("SUB_CATS").":</b> ";
