...
//
//  TorrentTrader v2.x
//      $LastChangedDate: 2012-07-04 01:54:06 +0100 (Wed, 04 Jul 2012) $
...
@($GLOBALS["___mysqli_ston"] = mysqli_connect($mysql_host,  $mysql_user,  $mysql_pass)) or err('dbconn: mysql_connect: ' . ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
@((bool)mysqli_query($GLOBALS["___mysqli_ston"], "USE " . $mysql_db)) or err('dbconn: mysql_select_db: ' . ((is_object($GLOBALS["___mysqli_ston"])) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)));
